import { bankAccounts, donationInfo } from '../data/banks';
  ...
  return (
    <section id="donasi-bank" className="py-20 px-4 bg-gradient-to-b from-white to-[#F9F5EB]">
      <div className="max-w-7xl mx-auto">
        ...
        {/* QRIS - Center - Pakai Gambar Asli qris-placeholder (DANA 62-813****5007) - FIXED INLINE */}
        <div className="max-w-md mx-auto mb-12">
          <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-2xl border-2 border-[#C1272D]/20 text-center relative overflow-hidden">
            ...
            <h3 className="font-black text-lg sm:text-xl text-gray-800">QRIS DANA - Aulia Komari</h3>
            <p className="text-xs sm:text-sm text-gray-500 mt-1">62-813****5007 • 081364755007 • Scan pakai DANA</p>
            
            {/* QRIS Asli - INLINE SVG biar 100% tampil tanpa file external */}
            <div className="mt-6 bg-white rounded-2xl border-2 border-gray-100 shadow-inner overflow-hidden">
              <QrisImage />
            </div>
