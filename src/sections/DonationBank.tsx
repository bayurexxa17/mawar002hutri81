import { bankAccounts, eWallets, qrisData, donationInfo } from '../data/banks';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <div className="mt-4 bg-amber-50 border border-amber-200 rounded-xl p-4 text-sm text-amber-800">
            💡 <strong>Tips:</strong> Gunakan <strong>BCA</strong> (utama) untuk validasi tercepat. Simpan bukti transfer untuk konfirmasi ke bendahara.
          </div>
        </div>
        ...
        <div className="mb-12">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {eWallets.map(wallet => (
              <BankCard key={wallet.id} account={wallet} type="ewallet" />
            ))}
          </div>
        </div>
