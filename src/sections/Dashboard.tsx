      ...
      <div className="max-w-7xl mx-auto">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
              ...
              <div className="p-3">
                <div className="bg-amber-50 border-l-4 border-amber-400 rounded-r-lg p-3 flex gap-2 text-sm text-gray-700">
                  <span>📌</span>
                  <div>Beberapa nama vendor/PJ (Kelong Baba, Indomart, Alfamart, Wesli) belum terkonfirmasi — mohon divalidasi ke panitia terkait sebelum finalisasi.</div>
                </div>
              </div>
            </div>
          </div>
        ...
        {activeTab === 'pendaftaran' && (
          <div className="grid lg:grid-cols-2 gap-6">
              ...
              <form onSubmit={handleRegister} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 gap-2 max-h-40 overflow-y-auto border rounded-lg p-3">
                    {['Makan Kerupuk', 'Futsal Mini', 'Tarik Tambang', 'Hias Tumpeng', 'Fashion Week Daster', 'Salah Sambung', 'JOget Jursi', 'Bawa Kelereng', 'Estafet Tepung', 'Estafet Penguin', 'Make Up Buta'].map(l => (
            ...
            <div className="bg-white rounded-xl shadow-sm border p-6">
              <h3 className="font-bold text-lg text-[#C1272D] mb-4">🏅 Daftar Peserta Lomba ({participants.length})</h3>
              <div className="overflow-x-auto">
        ...
        {activeTab === 'donasi' && (
          <div className="grid lg:grid-cols-2 gap-6">
            <div className="bg-white rounded-xl shadow-sm border p-6">
              <h3 className="font-bold text-lg text-[#C1272D] mb-4">❤️ Form Donasi</h3>
              <form onSubmit={handleDonasi} className="space-y-4">
                ...
                <button type="submit" className="w-full bg-[#C1272D] text-white font-bold py-3 rounded-lg hover:bg-red-700 transition">💖 Kirim Donasi</button>
              </form>
            </div>
                  ...
                  <tbody>
                    {budgetDetails[detailModal].items.map((item, i) => (
                      <tr key={item.no} className={i % 2 === 0 ? 'bg-[#F9F5EB]' : 'bg-white'}>
                        ...
                        <td className="px-4 py-3 text-right">{item.budget.toLocaleString('id-ID')}</td>
                      </tr>
                    ))}
                    <tr className="bg-[#C1272D]/10 font-bold border-t-2 border-[#C1272D]">
