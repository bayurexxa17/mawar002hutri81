              ...
              <div className="md:col-span-2">
                <div className="bg-gray-50 rounded-xl p-2 border">
                  <div className="bg-white rounded-lg p-3 text-xs">
                    <div className="font-black text-center text-red-700 text-sm mb-3">D. RUNDOWN HARI PELAKSANAAN (17 AGUSTUS 2026)</div>
                    <div className="space-y-3">
                      <div className="border border-green-200 rounded-lg p-2">
                        <div className="font-bold text-green-700 text-xs">PAGI 06.00-10.00 WIB</div>
                        <div className="text-[10px] mt-1 space-y-1">
                          <div>06.00-07.00 REGISTRASI PESERTA</div>
                          <div>07.00-08.00 UPACARA PERINGATAN</div>
                          <div>08.00-08.30 FOTO BERSAMA</div>
                        </div>
                      </div>
                      <div className="border border-red-200 rounded-lg p-2">
                        <div className="font-bold text-red-700 text-xs">SIANG 08.30-16.30 WIB</div>
                        <div className="text-[10px] mt-1 space-y-1">
                          <div>08.30-09.30 Lomba Anak-Anak</div>
                          <div>09.30-11.00 Lomba Remaja</div>
                          <div>11.00-12.30 Lomba Bapak-Bapak</div>
                          <div>13.00-15.00 Lomba Ibu-Ibu</div>
                          <div>15.00-16.30 Lomba Keluarga</div>
                        </div>
                      </div>
                      <div className="border border-amber-200 rounded-lg p-2">
                        <div className="font-bold text-amber-600 text-xs">MALAM 19.00-22.00 WIB</div>
                        <div className="text-[10px] mt-1 space-y-1">
                          <div>19.00-19.30 Hiburan Warga</div>
                          <div>19.30-20.00 Doorprize</div>
                          <div>20.00-20.30 Hias Tumpeng</div>
                          <div>20.30-21.30 Pembagian Hadiah</div>
                          <div>21.30-22.00 Penutupan</div>
                        </div>
                      </div>
                    </div>
                  </div>
