...
export const fundingSources: FundingSource[] = [
  ...
  { id: 6, sumber: 'Developer Ciptaland', jumlah: 1000000, catatan: 'PT Ciptaland Properti', status: 'confirmed' },
  { id: 7, sumber: 'Biznet Home', jumlah: 1000000, catatan: 'Provider internet', status: 'need_confirm' },
  { id: 8, sumber: 'XL Axiata', jumlah: 1000000, catatan: 'Telco provider', status: 'confirmed' },
  { id: 9, sumber: 'Proxinet', jumlah: 500000, catatan: 'Provider', status: 'confirmed' },
  { id: 10, sumber: 'IndiHome', jumlah: 500000, catatan: 'Telkom Group', status: 'confirmed' },
  { id: 11, sumber: 'Link Net / FirstMedia', jumlah: 1000000, catatan: 'Provider', status: 'confirmed' },
];
