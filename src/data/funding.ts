...
export const fundingSources: FundingSource[] = [
  ...
  { id: 7, sumber: 'Developer Ciptaland', jumlah: 1000000, catatan: 'PT Ciptaland Properti', status: 'need_confirm' },
  { id: 8, sumber: 'Biznet Home', jumlah: 1000000, catatan: 'Provider internet', status: 'need_confirm' },
  { id: 9, sumber: 'XL Axiata', jumlah: 1000000, catatan: 'Telco provider', status: 'need_confirm' },
  { id: 10, sumber: 'Proxinet', jumlah: 500000, catatan: 'Provider', status: 'need_confirm' },
  { id: 11, sumber: 'IndiHome', jumlah: 500000, catatan: 'Telkom Group', status: 'need_confirm' },
  { id: 12, sumber: 'Link Net / FirstMedia', jumlah: 1000000, catatan: 'Provider', status: 'need_confirm' },
];
