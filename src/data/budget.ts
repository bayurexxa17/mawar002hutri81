...
export const budgetDetails: Record<string, { title: string; subtitle: string; items: BudgetDetailItem[]; total: number; validated?: boolean }> = { 
  ...
  dana: { 
    ...
    items: [ 
      ...
      { no: 3, item: 'Sinar Pratama', detail: 'Donatur', budget: 1000000 },
      { no: 4, item: 'Kelong Baba Seafood', detail: 'Donatur tetap', budget: 1000000 }, 
      { no: 5, item: 'Alfamart', detail: 'Minimarket Tetap', budget: 1000000 }, 
      { no: 6, item: 'Indomart', detail: 'Minimarket Tetap', budget: 1000000 }, 
      { no: 7, item: 'Developer Ciptaland', detail: 'PT. CiptaLand Properti', budget: 1000000 }, 
      { no: 8, item: 'Biznet', detail: 'Provider internet', budget: 1000000 }, 
      { no: 9, item: 'XL Axiata', detail: 'Provider seluler', budget: 1000000 }, 
      { no: 10, item: 'IndiHome', detail: 'Telkom', budget: 500000 }, 
      { no: 11, item: 'Proxinet', detail: 'Provider', budget: 500000 }, 
