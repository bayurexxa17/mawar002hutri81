...
// Kartu "Panitia Pelaksana" (3 bintang + anggota lainnya)
...
// Default tabel "Susunan Panitia" (fallback bila tabel Supabase kosong)
export const defaultSusunanPanitia: { jabatan: string; nama: string; hp: string }[] = [
...
// Default kartu Informasi Acara
export const defaultInfoAcara = {
...
// Hari 1 — Acara Perlombaan (Senin, 17 Agustus 2026)
...
// Hari 2 — Acara Malam Puncak (Sabtu, 22 Agustus 2026)
export const rundownMalam: RundownItem[] = [
  { waktu: '19:30-20:00', kegiatan: 'Persiapan Panitia & Registrasi Kehadiran Warga', icon: '🎊', keterangan: 'Persiapan teknis, sound, panggung, kursi, dll' },
  { waktu: '20:00-20:05', kegiatan: 'Pembukaan Malam Puncak', icon: '🎤', keterangan: 'Pembukaan oleh MC' },
  { waktu: '20:05-20:10', kegiatan: 'Menyanyikan Lagu Indonesia Raya', icon: '🎶', keterangan: 'Piano by Ameera' },
  { waktu: '20:10-20:15', kegiatan: 'Pembacaan Doa', icon: '🤲', keterangan: 'Tokoh Agama' },
  { waktu: '20:15-20:20', kegiatan: 'Sambutan Ketua Panitia', icon: '🎙️', keterangan: 'Bayu S. Permana' },
  { waktu: '20:20-20:25', kegiatan: 'Sambutan Ketua RT', icon: '🏘️', keterangan: 'Bpk Eka Rista Yudhistira' },
  { waktu: '20:25-20:32', kegiatan: 'Tari Persembahan', icon: '💃', keterangan: 'Talenta Anak' },
  { waktu: '20:32–20:39', kegiatan: 'Tabola Bale (Biola & Vokal)', icon: '🎻🎤', keterangan: 'Solo Ameera' },
  { waktu: '20:39–20:51', kegiatan: 'Penghargaan Juara Anak Usia 5–8 Tahu', icon: '🏆', keterangan: 'Ketua Panitia, Wakil Ketua, Sponsor, Sie Hadiah & Dokumentasi' },
  { waktu: '20:51–20:58', kegiatan: 'Tari Zapin', icon: '💃', keterangan: 'Talenta Anak' },
  { waktu: '20:58–21:05', kegiatan: 'Tari Gugur Gunung', icon: '💃', keterangan: 'Talenta Anak' },
  { waktu: '21:05–21:17', kegiatan: 'Penghargaan Juara Anak Usia 9–12 Tahu', icon: '🏆', keterangan: 'Ketua Panitia, Ketua RT, Sponsor, Sie Hadiah & Dokumentasi' },
  { waktu: '21:17–21:24', kegiatan: 'Tari Tor-Tor', icon: '💃', keterangan: 'Talent' },
  { waktu: '21:24–21:29', kegiatan: 'Solo Vocal Anak (Opsional)', icon: '🎤', keterangan: 'Talent' },
  { waktu: '21:29–21:41', kegiatan: 'Penghargaan Juara Remaja', icon: '🏆', keterangan: 'Ketua RT, Ketua Panitia, Sponsor, Sie Hadiah & Dokumentasi' },
  { waktu: '21:41–21:44', kegiatan: 'Puisi Kemerdekaan (Opsional)', icon: '🎭', keterangan: 'Talent' },
  { waktu: '21.44–21.49', kegiatan: 'Atraksi Pencak Silat (Opsional)', icon: '🥋', keterangan: 'Talent' },
  { waktu: '21:49–22:05', kegiatan: 'Penilaian Lomba Hias Tumpeng', icon: '🍚', keterangan: 'Juri Panitia & Warga' },
  { waktu: '21:49–22:05', kegiatan: 'Akustik / 🎼 Keyboard (Opsional)', icon: '🎸', keterangan: 'Talent' },
  { waktu: '22:05–22:15', kegiatan: 'Penghargaan Juara Bapak-Bapak & Ibu-Ibu', icon: '🏆', keterangan: 'Ketua Pembina, Penasehat, Ketua RT, Ketua Panitia' },
  { waktu: '22:15–22:25', kegiatan: 'Penghargaan Juara Keluarga/Umum', icon: '🏆', keterangan: 'Ketua Pembina, Penasehat, Ketua RT, Ketua Panitia' },
  { waktu: '22:25–22:35', kegiatan: 'Doorprize Warg', icon: '🎁', keterangan: 'MC, Aulia Komari, Puput, Ketua Panitia' },
  { waktu: '22:35–22:40', kegiatan: 'Foto Bersama', icon: '📸', keterangan: 'Sie Dokumentasi' },
  { waktu: '22:40–22:45', kegiatan: 'Penutupan', icon: '👏', keterangan: 'MC' },
  { waktu: '22:45 – Selesai', kegiatan: 'Ramah Tamah & Makan Bersama', icon: '🍽️', keterangan: 'Seluruh Warga' },
];
