...
export interface LombaItem {
  ...
  nama: string;
  icon: string;
  kategori: 'anak' | 'remaja' | 'bapak' | 'ibu' | 'keluarga';
...
export const panitiaList: PanitiaItem[] = [
  ...
  { nama: 'Raihan', jabatan: 'Koordinator Lomba', hp: '0895-3851-06729' },
  { nama: 'Satria', jabatan: 'Koordinator Lomba', hp: '0819-9201-0197' },
  { nama: 'Fahri', jabatan: 'Koordinator Lomba', hp: '0821-8685-2140' },
  { nama: 'Agha', jabatan: 'Koordinator Lomba', hp: '0851-9433-4760' },
  { nama: 'Adib', jabatan: 'Koordinator Lomba', hp: '0813-6365-2626' },
  { nama: 'A.Fahri.K', jabatan: 'Koordinator Lomba', hp: '0813-2924-1359' },
...
export const rundownPagi: RundownItem[] = [
  ...
  { waktu: '13:00', kegiatan: 'Lomba Ibu-ibu (Hias Tumpeng, Fashion Daster, Lomba Estafet Tepung,  Joget Kursi)', icon: '👗', keterangan: 'Ibu-ibu' },
