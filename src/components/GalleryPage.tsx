...
const items: GalleryItem[] = [
  ...
  {
    id: 2, type: 'photo',
    thumb: 'https://images.pexels.com/photos/32293284/pexels-photo-32293284.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=400&w=600',
    full: 'https://images.pexels.com/photos/32293284/pexels-photo-32293284.jpeg?auto=compress&cs=tinysrgb&w=1920',
    title: 'Lomba Tradisional Anak-anak HUT RI',
    credit: 'Yazid N / Pexels',
  },
  {
    id: 3, type: 'photo',
    ...
    <div className="min-h-screen bg-[#F5F5F0]">
      ...
      <div className="max-w-5xl mx-auto px-4 pb-10">
        ...
        <div className="mt-12 bg-white rounded-2xl border-2 border-dashed border-gray-300 p-8 text-center">
          ...
          <div className="mt-4 text-[11px] bg-amber-50 border border-amber-200 rounded-xl p-3 text-left max-w-xl mx-auto">
            <div className="font-bold">Cara ganti preview lokal /images/20260726_091521.jpg:</div>
            <div className="mt-1">1. Taruh file JPG kamu di <code className="bg-white px-1 rounded">public/images/20260726_091521.jpg</code> (timpa file lama)</div>
            <div>2. Di <code>items[]</code> array, isi:</div>
            <div className="bg-zinc-900 text-emerald-300 rounded-lg p-2 mt-1 text-[10px] font-mono overflow-x-auto">thumb: '/images/20260726_091521.jpg',<br/>full: '/images/20260726_091521.jpg',</div>
            <div>3. Push: <code>git add . && git commit -m "ganti galeri preview" && git push</code></div>
          </div>
        </div>
      </div>
      ...
      {lightbox && (
        <div className="fixed inset-0 z-50 bg-black flex flex-col">
          ...
          <div className="text-center py-2 text-gray-600 text-[11px] bg-black/90">Klik area gelap untuk menutup • File: {lightbox.thumb}</div>
        </div>
      )}
