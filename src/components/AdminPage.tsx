...
export default function AdminPage({ onBack, shared }: Props) {
  ...
  const [tab, setTab] = useState<'peserta' | 'keuangan' | 'inventory' | 'talenta' | 'sponsor' | 'pengeluaran' | 'gallery' | 'panitia' | 'info' | 'rundown' | 'pelaksana' | 'musik' | 'slide'>('peserta');
  ...
  const TABLES_PROBE = ['pendaftar', 'keuangan', 'sponsor', 'donatur', 'kas_rt', 'pengeluaran', 'iuran_warga', 'donasi_cash', 'donasi_online', 'inventory', 'talenta', 'susunan_panitia', 'panitia_pelaksana', 'rundown', 'info_acara', 'slide_dokumentasi', 'gallery', 'musik'];
